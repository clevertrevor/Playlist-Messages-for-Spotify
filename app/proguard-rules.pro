...
-keepclassmembers class com.blogspot.spartandeveloper.playlistcreatorforspotify.data.model.** {
...
-keepclassmembers class com.blogspot.spartandeveloper.playlistcreatorforspotify.data.remote.RibotsService$** {
    !static !private <fields>;
}
